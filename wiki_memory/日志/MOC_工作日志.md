...
| 时间 | 类型 | 目标 | 状态 | 主题 | 日志 |
| --- | --- | --- | --- | --- | --- |
| 2026-09-01 | performance | 用字符退役、DPR 分层缓存、二维气流采样和确定性空间网格优化文字坠落到花朵，不降低动态质量。 | archived | lossless-glyph-to-flower-performance | [[日志/2026-09-01-文字坠落到花朵无损性能重构.md|2026-09-01｜文字坠落到花朵无损性能重构]] |
| 2026-09-01 | feature | 将蝴蝶重构为接近、环绕、悬停和邻花转访的确定性生态状态机，并固定代理步长。 | archived | ecological-butterfly-flower-visiting | [[日志/2026-09-01-重构蝴蝶生态访花机制.md|2026-09-01｜重构蝴蝶生态访花机制]] |
| 2026-09-01 | bug | 恢复 8 秒完成态后的蝴蝶花朵轨道、花朵风动和指针扰动，并加入持续运动回归检查。 | archived | restore-post-timeline-living-motion | [[日志/2026-09-01-恢复完成态持续飞行与指针扰动.md|2026-09-01｜恢复完成态持续飞行与指针扰动]] |
| 2026-09-01 | configuration | 将默认字符数量设为 160，并把控制台调整范围限制为默认值上下各 60。 | archived | default-160-glyphs-and-bounded-range | [[日志/2026-09-01-字符数量默认160与范围收窄.md|2026-09-01｜字符数量默认 160 与范围收窄]] |
